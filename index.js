...
exports.ParallaxProvider = function (_a) {
  ...
  var _b = [react_native_reanimated_1.useSharedValue(0), react_native_reanimated_1.useSharedValue(0)],
    posX = _b[0],
    posY = _b[1]
  ...
  return <AccelerometerContext.Provider value={{posX: posX, posY: posY}}>{children}</AccelerometerContext.Provider>
}
